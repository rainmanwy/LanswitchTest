...
proc main { } {
    ...
    foreach frame_length  $FRAME_LEN_LIST {
        ...
        ##统计计算测试值 ######################
        set tValue [expr double($tx_frame_count - $rx_frame_count)/$tx_frame_count]
        puts $tValue
        append ValueList "t3_6_thoughput_$frame_length:\"$tValue\","
        #puts $ValueList
    ...
    append ValueList "t3_6_result:\"$t3_6_result\"\}"
    puts $ValueList
